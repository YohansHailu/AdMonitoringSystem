...
res = fma.template_matching(frame1, frame1)
print("frame1 is equal to itself: ", res)

# compare frame1 with itself
res = fma.template_matching(frame1, frame2)
...
res = fma.template_matching(frame2, bright_frame2)
